...
import { showErrorMessage } from "../../js/utils";
...
pristine.addValidator(imgUploadForm.querySelector('.text__hashtags'), validateHashtags, 'введён невалидный хэштег');
...
export const setUserFormSubmit = (onSuccess, data) => {
